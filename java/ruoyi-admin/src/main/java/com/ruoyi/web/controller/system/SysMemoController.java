...
public class SysMemoController extends BaseController
{
    ...
    @GetMapping("/list")
    @DataScope(deptAlias = "sys_memo",userAlias = "sys_memo")
    ...
    {
        return success(sysMemoService.selectSysMemoByMemoId(memoId));
    }
    ...
    {
        return toAjax(sysMemoService.deleteSysMemoByMemoIds(memoIds));
    }
}
