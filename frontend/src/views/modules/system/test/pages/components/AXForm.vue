        ...
        <template #extra>
          <a-button htmlType="submit" type="primary" :loading="loading" block>保存</a-button>
           ...
           <a-form-item label="富文本字段" name="richTextField">
             <a-textarea placeholder="请输入富文本字段" v-model:value="testForm.richTextField"></a-textarea>
           </a-form-item>
           <a-form-item label="下拉框字段" name="selectField">
             <a-select placeholder="请输入下拉框字段" v-model:value="testForm.selectField">
             </a-select>
           </a-form-item>
           ...
           <a-form-item label="文本域" name="textareaField">
             <a-textarea placeholder="请输入文本域" v-model:value="testForm.textareaField"></a-textarea>
           </a-form-item>
